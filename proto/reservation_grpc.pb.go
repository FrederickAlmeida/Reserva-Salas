...
const (
	ReservationService_ListAvailable_FullMethodName      = "/booking.v1.ReservationService/ListAvailable"
	ReservationService_CreateReservation_FullMethodName  = "/booking.v1.ReservationService/CreateReservation"
	ReservationService_CancelReservation_FullMethodName  = "/booking.v1.ReservationService/CancelReservation"
	ReservationService_ConfirmReservation_FullMethodName = "/booking.v1.ReservationService/ConfirmReservation"
)
...
func (c *reservationServiceClient) ListAvailable(ctx context.Context, in *ListAvailableRequest, opts ...grpc.CallOption) (*ListAvailableResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListAvailableResponse)
	err := c.cc.Invoke(ctx, ReservationService_ListAvailable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReservationServiceServer) ListAvailable(context.Context, *ListAvailableRequest) (*ListAvailableResponse, error) {
...
func _ReservationService_ListAvailable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAvailableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReservationServiceServer).ListAvailable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_ListAvailable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReservationServiceServer).ListAvailable(ctx, req.(*ListAvailableRequest))
	}
...
var ReservationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "booking.v1.ReservationService",
	HandlerType: (*ReservationServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListAvailable",
			Handler:    _ReservationService_ListAvailable_Handler,
		},
		{
